        ...
        "post": [
            ...
            },
            {
                ...
                "paragraph": [
                    ...
                    `Next to learn are the myriad tags. Just tons of information to learn, much is obsolete and can be looked up, but I've got to learn enough to know what to look for and where to quickly find it.`,
            ...
            },
            {
                ...
                "paragraph": [
                    ...
                    `I need to be putting in more applications every week. More important is to get some websites together and hang out my own shingle: "Doc Oliver will fix yer sick website 'til itz healthy and fit as a fiddle."`
                ]
            },
            {
                ...
                "paragraph": [
                    ...
                    `Also slowing me down was the fact that I've never actually used WordPress. So just learning how to use it to add content and see what a non-programmer user could do to customize it was a prerequisite of the course. Learning how to set it up on my computer was fun and now I'm ready to set up a site for my neighborhood association.`,
                    `By Saturday I was making good progress in the course. My plan is to finish it, coding and testing everything on my local machine. Then go through the course again, both coding in my local sandbox site but also design an actual custom theme for my blog. I'll move my blog from its current location and framework (React) to WordPress. Furthermore I plan to build a couple of plugins, a ToDo list. Then I'll do a blog for my wife, or maybe a family site, then do a couple of restaurant sites, just for showing off my newly acquired WP customizing chops.`
                ]
            },
            {
            ...
            },
            {
                ...
                "paragraph": [
                    ...
                    `Speaking of "madness" while my wife has been in Port Sulphur I've been managing my mood by getting up at 6am sharp and getting to bed extra early, both of which are amazingly easier to do without her. Then I have a longer bike ride than normal, seven miles or so, followed by a cold shower and breakfast with coffee. The cold shower does wonders to refresh me and put me in a positive mood to start the day. I do well so long as I don't drink too much coffee or read the news.`,
            ...
            },
            {
                ...
                "paragraph": [
                    ...
                    `On the home front I'm going to put some effort into some projects around the house. Namely getting the table-saw sled built so I can finish the shelves in the master bath. Hooking the fridge up to the other water supply should fix the low water pressure of the water it delivers so that will be nice during this summer's oppressive heat. I want to get back into drawing so I'll start with a sketch a day project starting Monday. And it is time to bump up my Esperanto studies.`
                ]
            },
            {
